...
```bash
git clone https://github.com/shubhamdubey02/subnet.git
cd contracts
npm install
```
...
For more information about precompiles see [subnet-evm precompiles](https://github.com/shubhamdubey02/subnet#precompiles).

## Hardhat Config

Hardhat uses `hardhat.config.js` as the configuration file. You can define tasks, networks, compilers and more in that file. For more information see [here](https://hardhat.org/config/).

In Subnet-EVM, we provide a pre-configured file [hardhat.config.ts](https://github.com/shubhamdubey02/subnet/blob/master/contracts/hardhat.config.ts).
