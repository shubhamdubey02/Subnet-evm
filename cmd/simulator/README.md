...
To start a single node network, follow the instructions from the AvalancheGo [README](https://github.com/cryft-labs/cryftgo#building-avalanchego) to build from source.
