...
func TestPrecompileBind(t *testing.T) {
	...
	pwd, _ := os.Getwd()
	replacer := exec.Command(gocmd, "mod", "edit", "-x", "-require", "github.com/shubhamdubey02/subnet@v0.0.0", "-replace",github.com/shubhamdubey02/subnetbnet="+filepath.Join(pwd, "..", "..", "..", "..")) // Repo root
	replacer.Dir = pkg
